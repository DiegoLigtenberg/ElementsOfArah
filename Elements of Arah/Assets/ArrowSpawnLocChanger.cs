...
public class ArrowSpawnLocChanger : MonoBehaviour
{
    ...
    void Awake()
    {
        //  if ()
        {
            ...
            {
                tf.localPosition = new Vector3(tf.localPosition.x + 0.1f, tf.localPosition.y, tf.localPosition.z);
                //rechts
                ...
                {
                    tf.localPosition = new Vector3(tf.localPosition.x - 0.25f, tf.localPosition.y, tf.localPosition.z);
                    wasrunningleft = true;
                }
    ...
    void Update()
    {
        ...
        //if ()
        {
            ...
            */
            float temp = 0.04f; //(0.00025f - Gun.offsetcamera / 400000) ;
