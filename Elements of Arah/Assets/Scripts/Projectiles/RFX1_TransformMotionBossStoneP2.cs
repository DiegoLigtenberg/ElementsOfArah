...
public class RFX1_TransformMotionBossStoneP2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Target = GameObject.Find("Warrior Idle/Fire Ability Locations/StoneFromAir/P2StoneFromAir AimInAir");
